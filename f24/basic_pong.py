...
#You need to install pygame on Microsoft visual studio code. You need to do this only once as given below
#i) Open Microsoft Visual Stuido code
#ii) In the "terminal" tab type python -m pip install pygame (press return). Wait for installation to complete
#iii) Close and re-open Microsoft Visual Stuido code and run this file
#iv) If you see a paddle and a ball then you are all set.
...
while running:
    ...
    #Basic pong edit #1 You need to write code to detect the walls and the paddle

    #Basic pong edit #2 You also need to write code that will ensure the proper physics after the ball bounces
